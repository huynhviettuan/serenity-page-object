...
public class CommonPage extends PageObject {
    ...
    protected CommonPage(WebDriver driver, Predicate<? super PageObject> callback) {
       super(driver,callback);
    }

    public CommonPage(WebDriver driver, int ajaxTimeout) {
    ...
    public CommonPage(WebDriver driver, EnvironmentVariables environmentVariables) {
    ...
    private static void uploadFileToSytem(String fileLocation) {
        try {
    ...
    public void waitForTheElementToBeClickable(String element) {
    ...
    public void dragAndDropToThe(String resouce, String dest) {
    ...
    public void dragAndDropHtml5(String resouce, String des, int xOffset, int yOffset) throws AWTException {
